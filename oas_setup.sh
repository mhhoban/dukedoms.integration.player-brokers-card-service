...
curl https://raw.githubusercontent.com/mhhoban/dukedoms.card_service_api/master/dukedoms_player_service_api.yaml -O
mv dukedoms_player_service_api.yaml player_brokers_card_tests/swagger/player_service_api.yaml

curl https://raw.githubusercontent.com/mhhoban/dukedoms.card_broker_api/master/action_card_broker_api.yaml -O
